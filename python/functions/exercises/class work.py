...
num = int(input("please enter a number to check if he is positive/negative"))
if num>0:
    print("Positive")
elif num == 0:
    print("Zero")
...
#2כתוב תוכנית שקולטת מספר ובודקת אם הוא זוגי או אי זוגי 
...
#4תוכנית שקולטת 2 מספרים מחשבת ממוצע ומדפיסה
...
hours = minutes//60
if minutes>60:
    print(f"{hours}:{minutes%60} more than an hour")
else:
